...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.message || 'Failed to register. This email may already be taken.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-4">
      <div className="max-w-md w-full mx-auto">
        <h1 className="text-4xl font-bold text-center text-slate-900 mb-2">Create Your Account</h1>
        <p className="text-center text-slate-500 mb-8">Get started with your AI-powered job search.</p>
